...
export const NAVER_AUTH_URL = API_BASE_URL + 'naver?redirect_uri=' + OAUTH2_REDIRECT_URI;
export const KAKAO_AUTH_URL = API_BASE_URL + 'kakao?redirect_uri=' + OAUTH2_REDIRECT_URI;
